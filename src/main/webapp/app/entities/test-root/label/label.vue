  ...
  <div>
    <h2 id="page-heading" data-cy="LabelHeading">
      ...
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          ...
          <span v-text="$t('jhipsterApp.testRootLabel.home.refreshListLabel')">Refresh List</span>
        </button>
      </div>
    </h2>
    <br />
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('labelName')">
              <span v-text="$t('jhipsterApp.testRootLabel.labelName')">Label Name</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="jhipsterApp.testRootLabel.delete.question" data-cy="labelDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="-delete-label-heading" v-text="$t('jhipsterApp.testRootLabel.delete.question', { id: removeId })">
