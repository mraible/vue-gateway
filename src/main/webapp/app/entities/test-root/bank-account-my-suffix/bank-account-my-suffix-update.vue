  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhipsterApp.testRootBankAccount.home.createOrEditLabel"
          data-cy="BankAccountCreateUpdateHeading"
          v-text="$t('jhipsterApp.testRootBankAccount.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterApp.testRootBankAccount.name')" for="bank-account-my-suffix-name"
              >Name</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterApp.testRootBankAccount.guid')" for="bank-account-my-suffix-guid"
              >Guid</label
            >
            <input
              type="text"
              class="form-control"
              name="guid"
              id="bank-account-my-suffix-guid"
              data-cy="guid"
              :class="{ valid: !$v.bankAccount.guid.$invalid, invalid: $v.bankAccount.guid.$invalid }"
              v-model="$v.bankAccount.guid.$model"
            />
          </div>
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('jhipsterApp.testRootBankAccount.bankNumber')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('jhipsterApp.testRootBankAccount.agencyNumber')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('jhipsterApp.testRootBankAccount.lastOperationDuration')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('jhipsterApp.testRootBankAccount.meanOperationDuration')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('jhipsterApp.testRootBankAccount.meanQueueDuration')"
              for="bank-account-my-suffix-meanQueueDuration"
              >Mean Queue Duration</label
            >
            <input
              type="text"
              class="form-control"
              name="meanQueueDuration"
              id="bank-account-my-suffix-meanQueueDuration"
              data-cy="meanQueueDuration"
              :class="{ valid: !$v.bankAccount.meanQueueDuration.$invalid, invalid: $v.bankAccount.meanQueueDuration.$invalid }"
              v-model="$v.bankAccount.meanQueueDuration.$model"
            />
          </div>
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterApp.testRootBankAccount.balance')" for="bank-account-my-suffix-balance"
              >Balance</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('jhipsterApp.testRootBankAccount.openingDay')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('jhipsterApp.testRootBankAccount.lastOperationDate')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterApp.testRootBankAccount.active')" for="bank-account-my-suffix-active"
              >Active</label
            >
            <input
              type="checkbox"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('jhipsterApp.testRootBankAccount.accountType')"
            ...
            >
              <option
                ...
                v-bind:label="$t('jhipsterApp.BankAccountType.' + bankAccountType)"
              >
                {{ bankAccountType }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('jhipsterApp.testRootBankAccount.attachment')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('jhipsterApp.testRootBankAccount.description')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterApp.testRootBankAccount.user')" for="bank-account-my-suffix-user"
              >User</label
            >
