    ...
    <div class="col-8">
      <div v-if="bankAccount">
        <h2 class="jh-entity-heading" data-cy="bankAccountDetailsHeading">
          <span v-text="$t('jhipsterApp.testRootBankAccount.detail.title')">BankAccountMySuffix</span> {{ bankAccount.id }}
        </h2>
        <dl class="row jh-entity-details">
          ...
          <dd>
            <span>{{ bankAccount.meanQueueDuration | duration }} ({{ bankAccount.meanQueueDuration }})</span>
          </dd>
          <dt>
