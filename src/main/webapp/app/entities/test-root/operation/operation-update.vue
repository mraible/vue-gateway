  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhipsterApp.testRootOperation.home.createOrEditLabel"
          data-cy="OperationCreateUpdateHeading"
          v-text="$t('jhipsterApp.testRootOperation.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterApp.testRootOperation.description')" for="operation-description"
              >Description</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterApp.testRootOperation.bankAccount')" for="operation-bankAccount"
              >Bank Account</label
            >
            <select
              class="form-control"
