  ...
  <div>
    <h2 id="page-heading" data-cy="OperationHeading">
      ...
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          ...
          <span v-text="$t('jhipsterApp.testRootOperation.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'OperationCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('jhipsterApp.testRootOperation.home.createLabel')"> Create a new Operation </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="jhipsterApp.testRootOperation.delete.question" data-cy="operationDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="-delete-operation-heading" v-text="$t('jhipsterApp.testRootOperation.delete.question', { id: removeId })">
