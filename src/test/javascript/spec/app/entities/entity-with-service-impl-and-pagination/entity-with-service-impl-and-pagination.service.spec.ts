...
describe('Service Tests', () => {
  describe('EntityWithServiceImplAndPagination Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new EntityWithServiceImplAndPagination(123, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a EntityWithServiceImplAndPagination', async () => {
      ...
      it('should not update a EntityWithServiceImplAndPagination', async () => {
      ...
      it('should partial update a EntityWithServiceImplAndPagination', async () => {
      ...
      it('should not partial update a EntityWithServiceImplAndPagination', async () => {
      ...
      it('should not return a list of EntityWithServiceImplAndPagination', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a EntityWithServiceImplAndPagination', async () => {
