...
describe('Service Tests', () => {
  describe('EntityWithServiceImplAndDTO Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new EntityWithServiceImplAndDTO(123, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a EntityWithServiceImplAndDTO', async () => {
      ...
      it('should not update a EntityWithServiceImplAndDTO', async () => {
      ...
      it('should partial update a EntityWithServiceImplAndDTO', async () => {
      ...
      it('should not partial update a EntityWithServiceImplAndDTO', async () => {
      ...
      it('should not return a list of EntityWithServiceImplAndDTO', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a EntityWithServiceImplAndDTO', async () => {
