...
describe('Component Tests', () => {
  describe('EntityWithPaginationAndDTO Management Component', () => {
    ...
    it('Should call load all on init', async () => {
      ...
      expect(comp.entityWithPaginationAndDTOS[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(entityWithPaginationAndDTOServiceStub.retrieve.callCount).toEqual(1);
