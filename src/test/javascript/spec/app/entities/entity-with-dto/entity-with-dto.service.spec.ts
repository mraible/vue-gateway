...
describe('Service Tests', () => {
  describe('EntityWithDTO Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new EntityWithDTO(123, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a EntityWithDTO', async () => {
      ...
      it('should not update a EntityWithDTO', async () => {
      ...
      it('should partial update a EntityWithDTO', async () => {
      ...
      it('should not partial update a EntityWithDTO', async () => {
      ...
      it('should not return a list of EntityWithDTO', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a EntityWithDTO', async () => {
